        ...
        <div className="bg-cover bg-repeat bg-opacity-10" style={{ backgroundImage: `url('images/banner-pic.png')` }}>
            ...
            <div className="backdrop-blur-sm font-nunito flex flex-col relative max-w-5xl mx-auto pt-20 sm:pt-12 lg:pt-18">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <h3 className="text-nunito-900 font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white"> What is the NAS?</h3>
                </div>

                <div className="text-nunito-400 text-2xl sm:text-3xl lg:text-4xl tracking-tight dark:text-white p-4 text-grey opacity-60">
                    <p className="my-4">The NAS (Nurses Assignment Sheet) is an electronic document that replaces the paper based nurses
                        assignment sheet used in some healthcare settings. It is used to communicate vital information to nurses
                        throughout the shift.
                    </p>
                    <p className="my-4">The NAS provides nurses with clear patient assignments and outlines their expected duties.
            ...
            <div className="backdrop-blur-sm font-nunito flex flex-col relative max-w-5xl mx-auto pt-20 sm:pt-12 lg:pt-18">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <h3 className="text-nunito-900 font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white">Why Use the NAS?</h3>
                </div>

                <div className="text-nunito-400 text-2xl sm:text-3xl lg:text-4xl tracking-tight dark:text-white p-4 text-grey">
                    <p className="my-4">Using the NAS offers several advantages including, but not limited to:</p>
                    <ul className="list">

                    <p className="text-green font-bold">Efficiency:</p>
                        <li className="my-4 opacity-60">
                            Electronic assignment sheets streamline the process of assigning and communicating
                        ...
                        <li className="my-4 opacity-60">
                            Electronic nurses' assignment sheets contribute to a reduction in errors compared to
                        ...
                        <li className="my-4 opacity-60">
                            Electronic systems can capture and store data, allowing for analysis and
                        ...
                        <li className="my-4 opacity-60">
                            Shifting from paper-based assignment sheets to electronic ones reduces paper
            ...
            <div>
                ...
                <div className="backdrop-blur-sm font-nunito flex flex-col relative max-w-5xl mx-auto pt-20 sm:pt-12 lg:pt-18 my-8">
                    ...
                    <div className="flex flex-row items-center">
                        ...
                        <h3 className="text-nunito-900 font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white">The unique features of the NAS:</h3>
                    </div>
                    ...
                    <div className="text-nunito-400 text-2xl sm:text-3xl lg:text-4xl tracking-tight dark:text-white p-4 text-grey">
                        ...
                        <div className="text-nunito-400 text-2xl sm:text-3xl lg:text-4xl tracking-tight dark:text-white p-4 text-grey">
                            <h4 className="text-green font-bold my-4">Creating Electronic Sheets for Future Dates</h4>
                            <p className="opacity-60">
                                With the NAS, healthcare professionals can effortlessly generate electronic sheets for future
                                dates, enabling them to plan and organize patient information in advance. This powerful feature
                                streamlines the process of preparing for upcoming shifts, eliminating the need for manual data 
                                entries and ensuring the information is up-to-date and accurate.</p>
                        </div>



                        <div className="text-nunito-400 text-2xl sm:text-3xl lg:text-4xl tracking-tight dark:text-white p-4 text-grey">
                            <h4 className="text-green font-bold my-4">Duplication Safeguards</h4>
                            <p className="opacity-60">
