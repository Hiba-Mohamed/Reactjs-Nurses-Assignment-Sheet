    ...
    >
      <div className="font-nunito flex flex-row relative max-w-5xl mx-auto mb-16">
        <div className="flex flex-col items-center w-screen mb-8">
          ...
          <p className="text-nunito-900 font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white">
          ...
          <div className="flex items-center">
            <button
              ...
              className="bg-lgreen hover:bg-green text-white font-bold py-4 px-8 rounded m-10 lg:text-xl sm:text-l"
            >
              Create Account
            </button>
            <button
