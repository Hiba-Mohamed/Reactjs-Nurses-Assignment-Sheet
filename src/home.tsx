      ...
      <div className="font-nunito font-bold flex flex-row relative max-w-5xl mx-auto pt-20 sm:pt-12 lg:pt-18">
        ...
        <div className="flex flex-col items-center w-screen">
          ...
          <div className="flex items-center">
            <button className="bg-lgreen hover:bg-green text-white font-bold py-4 px-8 rounded m-10 text-xl">Create Account</button>
            <button className="bg-green hover:bg-lgreen text-white font-bold py-4 px-8 rounded m-10 text-xl">Login</button>
          </div>
